    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.empresa.store') }}">
                        @csrf

                        <input id="tipousers" type="hidden"  name="tipousers" value="Empresa" >
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            <label for="nombre_responsable" class="col-md-4 col-form-label text-md-end">{{ __('Nombre del encargado') }}</label>

                            <div class="col-md-6">
                                <input id="nombre_responsable" type="text" class="form-control @error('nombre_responsable') is-invalid @enderror" name="nombre_responsable" value="{{ old('nombre_responsable') }}" required autocomplete="nombre_responsable" autofocus>
